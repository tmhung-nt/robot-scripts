*** Settings ***
Documentation     Checking out the built-in library    # Many ways to run:    # pybot -d results/built-in tests/Built_in.robot    # pybot -d results/built-in -i BuiltIn tests    # pybot -d results tests
Library           Selenium2Library

*** Variables ***
${GLOBAL1}        I am global variable 1
${SOME_GLOBAL_DATA}    ${EMPTY}
